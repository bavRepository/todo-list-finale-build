...
import type { DomainTodolist, FilterValues } from "@/features/todolists/lib/types/types.ts"
  ...
  const changeFilter = (filter: FilterValues) => {
    dispatch(
      todolistsApi.util.updateQueryData("fetchTodolists", undefined, (todolists) => {
        const index = todolists.findIndex((todolist:DomainTodolist) => todolist.id === id)
